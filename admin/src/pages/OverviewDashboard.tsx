    ...
    const fetchOverviewData = async () => {
      try {
        const [usersRes, familiesRes, reportsRes, recentUsersRes] = await Promise.all([
          ...
          // Optimization: Use Supabase's count feature ({ count: 'exact', head: true }) instead of
          // fetching all row data just to determine the array length, saving network bandwidth and memory.
